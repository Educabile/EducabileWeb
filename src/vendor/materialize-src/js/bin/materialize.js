...
M.checkWithinContainer = function(container, bounding, offset) {
  ...
  if (
    scrolledY + bounding.height > containerRect.bottom - offset ||
...
;(function(r) {
  ...
  function r(a, c) {
    for (
      var d = a.length, b = 2 <= arguments.length ? arguments[1] : void 0, f = [], n = 0;
      n < d;
      n++
    ) {
      if (n in a) {
  ...
  function E(a, c) {
    if (c in a.style)
      return (
        getComputedStyle(a).getPropertyValue(c.replace(/([a-z])([A-Z])/g, '$1-$2').toLowerCase()) ||
        '0'
      )
  }
  function J(a, c) {
    ...
    function k(a) {
      ...
      a >= k &&
        (g.remaining
          ...
          : (g.pause(),
            g.completed ||
              ((g.completed = !0), f('complete'), 'Promise' in window && (p(), (m = c())))),
        (l = 0))
    }
    a = void 0 === a ? {} : a
    var h,
      ...
      [
        {
          key: 'init',
          value: function init(els, options) {
            return _get(Modal.__proto__ || Object.getPrototypeOf(Modal), 'init', this).call(
              this,
              this,
              els,
              options
      ...
      [
        ...
        },
        {
          ...
          value: function _calcRightPos(el) {
            return Math.ceil(
              this.tabsWidth - el.position().left - el[0].getBoundingClientRect().width
            )
          },
      ...
      [
        {
          key: 'init',
          value: function init(els, options) {
            return _get(Tabs.__proto__ || Object.getPrototypeOf(Tabs), 'init', this).call(
              this,
              this,
              els,
              options
      ...
      [
        {
          key: 'init',
          value: function init(els, options) {
            return _get(Slider.__proto__ || Object.getPrototypeOf(Slider), 'init', this).call(
              this,
              this,
              els,
              options
      ...
      [
        {
          key: 'init',
          value: function init(els, options) {
            return _get(Chips.__proto__ || Object.getPrototypeOf(Chips), 'init', this).call(
              this,
              this,
              els,
              options
      ...
      [
        {
          key: 'init',
          value: function init(els, options) {
            return _get(Range.__proto__ || Object.getPrototypeOf(Range), 'init', this).call(
              this,
              this,
              els,
              options
