  ...
  return (
    <div className="container">
      ...
      <p className="flow-text">
        ...
        consultano. Si tratta di un’informativa che è resa anche ai sensi
        dell'art. 13 del d.lgs. n. 196/2003 - Codice in materia di protezione
        dei dati personali a coloro che interagiscono con i servizi web della
        Educabile Srl accessibili per via telematica a partire dall’indirizzo:
        <a href="https://www.educabile.it">https://www.educabile.it</a>.
        L’informativa è resa solo per il sito della Educabile Srl e non anche
        ...
        autorità europee per la protezione dei dati personali, riunite nel
        Gruppo istituito dall’art. 29 della direttiva n. 95/46/CE, hanno
      ...
      <p className="flow-text">
        ...
        loro trattamento è la Educabile Srl che ha sede in Napoli (NA) - Italia,
        Via E. Nicolardi, 109
      </p>
      ...
      <p className="flow-text">
        ...
        la predetta sede della Educabile Srl e sono curati solo da personale
        tecnico dell’Ufficio incaricato del trattamento, oppure da eventuali
        incaricati di occasionali operazioni di manutenzione. Nessun dato
        derivante dal servizio web viene comunicato o diffuso. I dati personali
        forniti dagli utenti che inoltrano richieste di invio di materiale
        informativo (newsletter, documenti, risposte a quesiti, ecc.) sono
      ...
      <p className="flow-text">
        ...
        preposte al funzionamento di questo sito web acquisiscono, nel corso del
        ...
        informatici ai danni del sito: salva questa eventualità, allo stato i
        dati sui contatti web non persistono per più di sette giorni. Dati
        forniti volontariamente dall’utente: l’invio facoltativo, esplicito e
        volontario di posta elettronica agli indirizzi indicati su questo sito
        comporta la successiva acquisizione dell’indirizzo del mittente,
        necessario per rispondere alle richieste, nonché degli eventuali altri
        dati personali inseriti nella missiva. Specifiche informative di sintesi
      ...
      <p className="flow-text">
        Nessun dato personale degli utenti viene in proposito acquisito dal
        sito. Non viene fatto uso di cookies per la trasmissione di informazioni
        di carattere personale, né vengono utilizzati c.d. cookies persistenti
        di alcun tipo, ovvero sistemi per il tracciamento degli utenti. L’uso di
        c.d. cookies di sessione (che non vengono memorizzati in modo
        ...
        per consentire l’esplorazione sicura ed efficiente del sito. I c.d.
        cookies di sessione utilizzati in questo sito evitano il ricorso ad
      ...
      <p className="flow-text">
        ...
        di fornire i dati personali riportati nei moduli di richiesta al Garante
        o comunque indicati in contatti con l'Ufficio per sollecitare l’invio di
        materiale informativo o di altre comunicazioni. Il loro mancato
        conferimento può comportare l’impossibilità di ottenere quanto
        richiesto. Per completezza va ricordato che in alcuni casi (non oggetto
        dell’ordinaria gestione di questo sito) l’Autorità può richiedere
        notizie e informazioni ai sensi dell'art 157 del d.lgs. n. 196/2003, ai
        fini del controllo sul trattamento dei dati personali. In questi casi la
      ...
      <p className="flow-text">
        ...
        l’esattezza o chiederne l’integrazione o l’aggiornamento, oppure la
        rettificazione (art. 7 del d.lgs. n. 196/2003). Ai sensi del medesimo
        articolo si ha il diritto di chiedere la cancellazione, la
      ...
      <p className="flow-text">
        Il presente documento, pubblicato all’indirizzo costituisce la “Privacy
        Policy” di questo sito che sarà soggetta ad aggiornamenti (restano le
        varie versioni consultabili al medesimo indirizzo).
      </p>
    </div>
  );
};
